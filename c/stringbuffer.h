...
struct XStringBuffer *
xstringbuffer_new_with_options(const size_t /* initial_size */,
...
bool xstringbuffer_ensure_capacity(struct XStringBuffer *,
                                   const size_t /* size */);
...
bool xstringbuffer_append_string_with_options(struct XStringBuffer *,
                                              const char *,
                                              const size_t /* offset */,
                                              const size_t /* length */);
bool xstringbuffer_append_binary(struct XStringBuffer *, const char *,
                                 const size_t /* offset */,
                                 const size_t /* length */);
...
bool xstringbuffer_append_unsigned_short(struct XStringBuffer *,
                                         unsigned short);
...
bool xstringbuffer_append_unsigned_long_long(struct XStringBuffer *,
                                             unsigned long long);
