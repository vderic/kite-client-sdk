...
static int kite_handle_exec(kite_handle_t *client, char **json, int n, char *errmsg, int errlen) {
...
static int kite_handle_assign_socket(kite_handle_t *client, int *sockfd, int nsocket, char *errmsg, int errlen) {
	struct event *ev;
...
static int kite_handle_connect(kite_handle_t *client, char **hosts, int nconnection, char *errmsg, int errlen) {
 ...
 */
int kite_next_row(kite_handle_t *client, xrg_iter_t **retiter, char *errmsg, int errlen) {
...
static int setup_schema(stringbuffer_t *sbuf, char *schema, char *errmsg, int errlen) {
...
static int setup_address(char *addr, char ***addrs, int *naddr, char *errmsg, int errlen) {
	char *tok;
	const char *sep = "\r\n";
	char *rest = addr;
	int maxaddr = 128;
